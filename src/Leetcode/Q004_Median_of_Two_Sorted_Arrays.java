...
public class Q004_Median_of_Two_Sorted_Arrays {
     ...
     * Basic Idea is very similar to K-selection.
     * it's easier to understand if you imagine this to be chopping off the last K elements
     * from a total of len(A) + len(B) elements, where K = (len(A) + len(B))/2.
